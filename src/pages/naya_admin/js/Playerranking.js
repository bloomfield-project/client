        ...
        <div className="body-container-1">
            ...
            <div className="body-container-2">
              ...
              <div className="table-box-1">
                ...
                <div className="table-row">
                    <div className="col-3-1"></div>
                    <div className="col-3-2"><img className="row-image" src={profpic} alt=""></img><a href="#">Gihan Perera</a></div>
                    <div className="col-3-3">900</div>
                </div>

                <hr></hr>
                <div className="table-row">
                    <div className="col-3-1"></div>
                    <div className="col-3-2"><img className="row-image" src={profpic} alt=""></img><a href="#">Sameera Sampath</a></div>
                    <div className="col-3-3">930</div>
                </div>
...
export default AdminCricketRanking;