              ...
              <TabPane tab="Batting" key="1">
                <div className="table-box-11">
                  <div className="table-tabs">
                    <button onClick={getODI} className={ODI}>
                      ODI
                    </button>
                    <button onClick={getT20} className={T20}>
                      T20
                    </button>
                    <button onClick={getTest} className={Test}>
                      TEST
                    </button>
                    <input
                      type="text"
                        ...
                        ?.filter((item) => {
                          return search.toLowerCase() === ""
                            ...
                            : item.name?.toLowerCase().includes(search) ||
                                item.avg?.includes(search) ||
                                item.sr?.includes(search);
                          // item.rating?.includes(search)
                        })
                          ...
                          <>
                            <div key={i} className="table-row">
                              ...
                              <div className="col-5-2">
                                <img
                                  className="row-image"
                                  src={item.image !== "" ? item.image : profpic}
                                  alt=""
                                ></img>
                                <a
                                  href={
                                    "/manager/playerRanking/" + item.user_id
                                  }
                                  style={{
                                    width: "80%",
                                    textAlign: "left",
                      ...
                      dataupcomming
                        ?.filter((item) => {
                          return search.toLowerCase() === ""
                            ? item
                            : item.name?.toLowerCase().includes(search) ||
                                // item.B_rating?.includes(search) ||
                                // item.b_wkts?.includes(search) ||
                                item.econ?.includes(search);
                        })
                        .sort((a, b) => (a.B_rating > b.B_rating ? -1 : 1))
                        .map((item, i) => (
                          <>
                            <div key={i} className="table-row">
                              <div className="col-5-1">{i + 1}</div>
                      ...
                      dataupcomming
                        ?.filter((item) => {
                          return search.toLowerCase() === ""
                            ? item
                            : item.name?.toLowerCase().includes(search) ||
                            item.avg?.includes(search) || item.sr?.includes(search) || item.econ?.includes(search);
                        }).sort((a, b) => (a.A_rating > b.A_rating ? -1 : 1))
                        .map((item, i) => (
                          <>
                            <div key={i} className="table-row">
                              <div className="col-7-1">{i + 1}</div>
